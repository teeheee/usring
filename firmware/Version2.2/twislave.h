...
#define buffer_size 16+16+2 								//Größe der Buffer in Byte (2..254)

//#################################### Schutz vor unsinnigen Buffergrößen
#if (buffer_size > 254)
	#error Buffer zu gros gewahlt! Maximal 254 Bytes erlaubt.
#endif

#if (buffer_size < 2)
	#error Buffer muss mindestens zwei Byte gros sein!
#endif
